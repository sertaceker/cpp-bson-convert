...
TEST(VectorInVectorPrimitive, Serialization)
{
    ...
    vecInVec.doubleList.push_back({1.1, 2.2, 3.3});
    vecInVec.doubleList.push_back({4.4, 5.5, 6.6});
    vecInVec.doubleList.push_back({7.7, 8.8, 9.9});

    const auto bson = VectorInVectorClass::toBSON(vecInVec);
    ASSERT_EQ(vecInVec.doubleList[0][0], bson["doubleList"][0][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][1], bson["doubleList"][0][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][2], bson["doubleList"][0][2].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0], bson["doubleList"][1][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][1], bson["doubleList"][1][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][2], bson["doubleList"][1][2].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0], bson["doubleList"][2][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][1], bson["doubleList"][2][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][2], bson["doubleList"][2][2].get_double().value);
}

TEST(VectorInVectorPrimitive, Deserialization)
{
    struct VectorInVectorClass
    {
        std::vector<std::vector<double>> doubleList;
    ...
    ASSERT_EQ(vecInVec.doubleList[0][0], deserialized.doubleList[0][0]);
    ASSERT_EQ(vecInVec.doubleList[0][1], deserialized.doubleList[0][1]);
    ASSERT_EQ(vecInVec.doubleList[0][2], deserialized.doubleList[0][2]);
    ASSERT_EQ(vecInVec.doubleList[1][0], deserialized.doubleList[1][0]);
    ASSERT_EQ(vecInVec.doubleList[1][1], deserialized.doubleList[1][1]);
    ASSERT_EQ(vecInVec.doubleList[1][2], deserialized.doubleList[1][2]);
    ASSERT_EQ(vecInVec.doubleList[2][0], deserialized.doubleList[2][0]);
    ASSERT_EQ(vecInVec.doubleList[2][1], deserialized.doubleList[2][1]);
    ASSERT_EQ(vecInVec.doubleList[2][2], deserialized.doubleList[2][2]);
}

TEST(VectorInVectorClass, Serialization)
{
    struct MyClass
    {
        std::vector<std::vector<double>> innerDoubleList;
    ...
    for (int i = 0; i < 3; ++i)
    {
        ...
        for (int j = 0; j < 3; ++j)
        {
            ...
            for (int k = 0; k < 3; ++k)
            {
                ...
                for (int l = 0; l < 3; ++l)
                {
                    innerDouble.push_back(i + j + k + l);
                }
                innerDoubleVec.push_back(innerDouble);
            }
            myClass.innerDoubleList = innerDoubleVec;
            innerVec.push_back(myClass);
        }
        vecInVec.doubleList.push_back(innerVec);
    }

    const auto bson = VectorInVectorClass::toBSON(vecInVec);

    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[0][0], bson["doubleList"][0][0]["innerDoubleList"][0][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[0][1], bson["doubleList"][0][0]["innerDoubleList"][0][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[0][2], bson["doubleList"][0][0]["innerDoubleList"][0][2].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[1][0], bson["doubleList"][0][0]["innerDoubleList"][1][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[1][1], bson["doubleList"][0][0]["innerDoubleList"][1][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[1][2], bson["doubleList"][0][0]["innerDoubleList"][1][2].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[2][0], bson["doubleList"][0][0]["innerDoubleList"][2][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[2][1], bson["doubleList"][0][0]["innerDoubleList"][2][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[2][2], bson["doubleList"][0][0]["innerDoubleList"][2][2].get_double().value);

    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[0][0], bson["doubleList"][1][0]["innerDoubleList"][0][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[0][1], bson["doubleList"][1][0]["innerDoubleList"][0][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[0][2], bson["doubleList"][1][0]["innerDoubleList"][0][2].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[1][0], bson["doubleList"][1][0]["innerDoubleList"][1][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[1][1], bson["doubleList"][1][0]["innerDoubleList"][1][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[1][2], bson["doubleList"][1][0]["innerDoubleList"][1][2].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[2][0], bson["doubleList"][1][0]["innerDoubleList"][2][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[2][1], bson["doubleList"][1][0]["innerDoubleList"][2][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[2][2], bson["doubleList"][1][0]["innerDoubleList"][2][2].get_double().value);

    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[0][0], bson["doubleList"][2][0]["innerDoubleList"][0][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[0][1], bson["doubleList"][2][0]["innerDoubleList"][0][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[0][2], bson["doubleList"][2][0]["innerDoubleList"][0][2].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[1][0], bson["doubleList"][2][0]["innerDoubleList"][1][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[1][1], bson["doubleList"][2][0]["innerDoubleList"][1][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[1][2], bson["doubleList"][2][0]["innerDoubleList"][1][2].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[2][0], bson["doubleList"][2][0]["innerDoubleList"][2][0].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[2][1], bson["doubleList"][2][0]["innerDoubleList"][2][1].get_double().value);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[2][2], bson["doubleList"][2][0]["innerDoubleList"][2][2].get_double().value);
}

TEST(VectorInVectorClass, Deserialization)
{
    struct MyClass
    {
        std::vector<std::vector<double>> innerDoubleList;
    ...
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[0][0], deserialized.doubleList[0][0].innerDoubleList[0][0]);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[0][1], deserialized.doubleList[0][0].innerDoubleList[0][1]);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[0][2], deserialized.doubleList[0][0].innerDoubleList[0][2]);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[1][0], deserialized.doubleList[0][0].innerDoubleList[1][0]);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[1][1], deserialized.doubleList[0][0].innerDoubleList[1][1]);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[1][2], deserialized.doubleList[0][0].innerDoubleList[1][2]);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[2][0], deserialized.doubleList[0][0].innerDoubleList[2][0]);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[2][1], deserialized.doubleList[0][0].innerDoubleList[2][1]);
    ASSERT_EQ(vecInVec.doubleList[0][0].innerDoubleList[2][2], deserialized.doubleList[0][0].innerDoubleList[2][2]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[0][0], deserialized.doubleList[1][0].innerDoubleList[0][0]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[0][1], deserialized.doubleList[1][0].innerDoubleList[0][1]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[0][2], deserialized.doubleList[1][0].innerDoubleList[0][2]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[1][0], deserialized.doubleList[1][0].innerDoubleList[1][0]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[1][1], deserialized.doubleList[1][0].innerDoubleList[1][1]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[1][2], deserialized.doubleList[1][0].innerDoubleList[1][2]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[2][0], deserialized.doubleList[1][0].innerDoubleList[2][0]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[2][1], deserialized.doubleList[1][0].innerDoubleList[2][1]);
    ASSERT_EQ(vecInVec.doubleList[1][0].innerDoubleList[2][2], deserialized.doubleList[1][0].innerDoubleList[2][2]);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[0][0], deserialized.doubleList[2][0].innerDoubleList[0][0]);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[0][1], deserialized.doubleList[2][0].innerDoubleList[0][1]);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[0][2], deserialized.doubleList[2][0].innerDoubleList[0][2]);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[1][0], deserialized.doubleList[2][0].innerDoubleList[1][0]);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[1][1], deserialized.doubleList[2][0].innerDoubleList[1][1]);
    ASSERT_EQ(vecInVec.doubleList[2][0].innerDoubleList[1][2], deserialized.doubleList[2][0].innerDoubleList[1][2]);
